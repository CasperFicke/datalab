...
def brk_nnp(request):
  ...
  return render(request, 'kadaster/brk_nnp.html', context)
...
def brk_np(request):
  ...
  if request.method == "POST":
    ...
    try:
      ...
      api_result = "Error..."
    context['api_result'] = api_result
  return render(request, 'kadaster/brk_np.html', context)
...
def brk_zg(request):
  ...
  return render(request, 'kadaster/brk_zg.html', context)
...
def brk_oz(request):
  ...
  if request.method == "POST":
    ...
    try:
      ...
      api_result = "Error..."
    context['api_result'] = api_result
  return render(request, 'kadaster/brk_oz.html', context)
